...
class RecentActivity(QWidget):
    ...
    def init_ui(self):
        ...
        # "View All" button centered below header
        ...
        header_layout.addWidget(view_all_btn, alignment=Qt.AlignmentFlag.AlignCenter)
        ...
        scroll_area.setMinimumHeight(320)  # Ensure activities fill the space better
        
        # Container for activities with improved spacing
        self.activities_container = QWidget()
        self.activities_layout = QVBoxLayout(self.activities_container)
        self.activities_layout.setContentsMargins(8, 2, 8, 8)  # Better margins
        self.activities_layout.setSpacing(6)  # Increased spacing between activities
        
        scroll_area.setWidget(self.activities_container)
        layout.addWidget(scroll_area, 1)  # Add stretch factor to fill available space
    ...
    def create_activity_widget(self, activity):
        ...
        container.setStyleSheet("""
            ...
            QFrame:hover {
                ...
                border-color: rgba(50, 184, 198, 0.25);
            }
        """)
