...
class FullActivityTab(QWidget):
    ...
    def create_statistics_overview(self):
        ...
        status_header.setStyleSheet("color: #FFFFFF; font-weight: 600; font-size: 14px; padding: 8px 12px; background-color: #2D2F31; border-radius: 6px;")
        ...
        runtime_header.setStyleSheet("color: #FFFFFF; font-weight: 600; font-size: 14px; padding: 8px 12px; background-color: #2D2F31; border-radius: 6px;")
        ...
        trends_header.setStyleSheet("color: #FFFFFF; font-weight: 600; font-size: 14px; padding: 8px 12px; background-color: #2D2F31; border-radius: 6px;")
...
{activity.get('error_message', '')}
    ...
    def view_task_logs(self):
        """View detailed logs for the selected task"""
        current_row = self.activity_table.currentRow()
        if current_row >= 0:
            activities = self.get_activity_data()
            if current_row < len(activities):
