...
# Output key files needed
print("\n\nKey Files in Full App:")
print("\n".join(app_files[:10]))  # Show just the first 10 key files

print("\n\nCollector Wrapper Count:", len(collector_wrappers))
print("Processor Wrapper Count:", len(processor_wrappers))
print("Total Dependency Count:", len(full_app_structure["dependencies"]))